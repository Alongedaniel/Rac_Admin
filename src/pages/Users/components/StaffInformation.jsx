...
const StaffInformation = ({ setActiveStep }) => {
  return (
    <>
      <Box mt="30px">
        <SectionHeader
          noBorder
          title="Confirm the Staff's Profile information"
        />
      ...
      <Box mt="30px">
        <SectionHeader
          noBorder
          title="Confirm the Staff's Additional Information"
        />
        <Box mt="20px" display="flex" gap="30px" alignItems="center">
          <Box width="100%" bgcolor="#EADDFF" height="48px"></Box>
